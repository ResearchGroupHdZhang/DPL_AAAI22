...
'''
import argparse
import AgentCEDM as Agent
from cedm.usersimulator import SimulatedUsersManager
...
if __name__ == '__main__':
    ...
    logger.dial("Random Seed is {}".format(seed))
    Ontology.init_global_ontology_cer()
