...
class DeepQNetwork(object):
    ...
    def __init__(self, sess, state_dim, action_dim, learning_rate, tau, \
        ...
        for head in range(no_head):
            ...
            self.heads.append(self.create_ddq_head(self.hidden, self.h1_size, self.h2_size))
        ...
        for head in range(no_head):
            ...
            self.target_heads.append(self.create_ddq_head(self.target_hidden, self.h1_size, self.h2_size))
