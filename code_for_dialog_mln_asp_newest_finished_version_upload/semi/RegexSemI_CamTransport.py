...
"""
RegexSemI_CamTransport.py - regular expression based CamHotels SemI decoder
=========================================================================
...
class RegexSemI_CamTransport(RegexSemI.RegexSemI):
    """
    """
    def __init__(self, repoIn=None):
        ...
        self.domainTag = "CamTransport"  #FIXME
