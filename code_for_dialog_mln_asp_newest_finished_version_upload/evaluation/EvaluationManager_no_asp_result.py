...
######################################################################    
    ...
    def print_summary(self):
        ...
        if num_dialogs:
            ...
            #             os.mkdir('./output-asp')
            #         with open('./output-asp/output-{}-{}-{}.txt'.format(
            #                 self.randomseed, self.inaccurate_asp, self.incomplete_asp), 'a+') as f:
            #             f.write(str(self.outcomes) + '\n')
            #     else:
            #         if not os.path.exists('./output'):
            #             os.mkdir('./output')
            #         with open('./output/output-{}-{}-{}.txt'.format(self.randomseed, self.add_knowledge,
            #                                                             self.add_asp), 'a+') as f:
            #             f.write(str(self.outcomes) + '\n')                    
            ...
            if not os.path.exists('./output'):
                os.mkdir('./output')
            if not os.path.exists('./output/'+ self.policytype):
                os.mkdir('./output/'+ self.policytype)
            # if self.learning_rate != -1:
            #     with open('./output/'+ self.policytype +'/output-{}-{}-{}-{}.txt'.format(self.randomseed, self.add_knowledge, self.policytype, self.learning_rate), 'a+') as f:
            #         f.write(str(self.outcomes) + '\n')
            # else:
            with open('./output/'+ self.policytype +'/output-{}-{}-{}-{}.txt'.format(self.randomseed, self.add_knowledge, self.policytype, self.domainString), 'a+') as f:
                f.write(str(self.outcomes) + '\n')
