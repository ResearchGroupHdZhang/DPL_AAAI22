...
'''
hlstm.py - Heuristically-Gated LSTM Generator.  
===========================================================
...
class hlstm(BaseRLG):
    '''
    Class for Heuristically-Gated LSTM Generator.
    '''
    ...
    def _form1hot(self, hot_x, idx_x, cutoff_x):
        '''
        Map DA to 1-hot representation
        '''
    ...
    def _batchAlign(self, w_tb, mask_b):
        '''
        Heuristically map gate activations to words
        '''
    ...
    def _get1hot(self,idxes,dim):
        '''
        Get DA 1-hot representation, in numpy
        '''
        vec = np.zeros(dim)
        vec[idxes] = 1.0
        return vec
